...
import AutomationScript.ExtentReportManager;
import AutomationScript.AutomateCopWellness;
import AutomationScript.AutomateCopWellness1;
import AutomationScript.AutomateFindHospitals;
import AutomationScript.Automatetopcities;
...
public class TestClass  {
	...
	ExtentReports report=ExtentReportManager.getReportInstance();
	  ...
	  public void CopWelleness() throws IOException
	  {
		  ...
		  cw1.screenshoot();
		  logger.log(Status.INFO, "Check the demo button enable or disabled");
		  cw1.Schedule_a_demo();
		  logger.log(Status.PASS, "Test Executed Successfully");
		  close();
	  }
